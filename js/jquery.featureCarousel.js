    ...
    $.fn.featureCarousel = function (options) {
        ...
        return $(this).each(function () {
            ...
            function setupCarousel() {
                ...
                pluginData.featuresContainer.find(".feature").addClass("smallPic");
            }
            ...
            function animateFeature($feature, direction)
            {
                ...
                if (newPosition != 1) {
                    ...
                    $feature.addClass("smallPic").find("h2").animate({
                        'font-size' : "15px"
                    },options.carouselSpeed);

                    $feature.find("p").animate({
                        'font-size' : "12px"
                    },options.carouselSpeed)
                } else {
                    $feature.removeClass("smallPic").find("h2").animate({
                        'font-size' : "18px"
                    },options.carouselSpeed);
				...
				$feature.children(".mask").show().animate({
					opacity: new_fade
				},options.carouselSpeed, function(){
						if(!new_fade){
							$(this).hide();
						}
					});
            ...
            pluginData.featuresContainer.children(".feature")
                .click(function () {
